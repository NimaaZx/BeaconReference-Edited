...
//    }
    ...
    val rangingObserver = Observer<Collection<Beacon>> { beacons ->
        ...
        if (BeaconManager.getInstanceForApplication(this).rangedRegions.size > 0) {
            ...
            beacons.forEach {
                Toast.makeText(this, "beacons are found , ${it.id2}", Toast.LENGTH_LONG).show()
    ...
    fun rangingButtonTapped(view: View) {
        ...
        beaconManager.apply {
            this.foregroundScanPeriod = 7000L
            this.foregroundBetweenScanPeriod = 4000L
            this.updateScanPeriods()
            this.beaconParsers.clear()
            this.beaconParsers.add(BeaconParser().setBeaconLayout("m:2-3=0215,i:4-8,i:4-19,i:20-21,i:22-23,p:24-24"))
        }
